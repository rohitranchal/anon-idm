...
public interface IdentityProviderConnection {
	...
	/**
	 * Establish the connection and carry out tasks such as obtaining identity provider policy and public key
	 * certificate.
	 * 
	...
	/**
	 * Request claim issuance. A random id will be created instead of the master key.
	 * 
	 * @param claim
	 *            Requested claim type.
	 * @param privKey
