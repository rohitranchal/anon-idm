...
client.generateNRequests(n, function(err, val){
	...
	request.post('http://localhost:8001/authenticate_n_claims_t', {form:{request:val}}, function (error, response, body) {
		if (!error && response.statusCode == 200) {

			client.extractSessionKeyNThreads(n, body, function(err, sk){
